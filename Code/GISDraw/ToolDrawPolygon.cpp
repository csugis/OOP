// ToolDrawPolygon.cpp: implementation of the CToolDrawPolygon class.
//
//////////////////////////////////////////////////////////////////////
...
CToolDrawPolygon::CToolDrawPolygon(CView * ownerObj):CBaseTool(ownerObj){
	SetToolType(toolTypeDrawPolygon);
...
CPoint* CToolDrawPolygon::GetVertex(){
...
BOOL CToolDrawPolygon::DrawPolygon(CDC* pDC){
	...
	if(lSize==1){
		...
		return pDC->Polygon(GetVertex(),m_vPoints.size());
	else
		return FALSE;
}
